...
ascii_banner = pyfiglet.figlet_format("FULLNET GG")
...
def send_complaint(username, telegram_id, number, email, repeats, complaint_choice, proxies=None):
	...
	print(colored("[1] Создатель execrime",
"white"))
def complaint():
	print(colored_banner)
	print(colored("[1] Виртуальный номер", "white"))
	print(colored("[2] Премиум Аккаунт","white"))
	print(colored("[3] Оскорбление","white"))
	print(colored("[4] Нарушение правил", "white"))
	print(colored("[5] Снос сессий", "white"))
	print(colored("[6] Спам", "white"))
	print(colored("[7] Снос Прайса", "white"))
	print(colored("[8] Накрутка", "white"))
	print(colored("[0] Владелец: @execrime", "white" ))
	complaint_choice = input(colored("Введите номер: ", "white"))

	if complaint_choice in ["1", "2", "3", "4", "6", "7", "8"]:
		username = input("Введите @юзер:; ")
